...
func (s *StatisticsService) GetStatistics(
	...
	// 	получаем список задач по фильтрации userID, from, to
...
func calcStatistics(tasks []domain.Task) domain.Statistics {
	if len(tasks) == 0 {
		// структура и так создается с этими значениями по умолчанию, можно не писать, но для прозрачности лучше сделать
