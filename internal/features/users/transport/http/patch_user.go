...
import (
	...
	core_http_types "github.com/fffeehh/practice_backend_todoapp/internal/core/transport/http/types"
...
// описываем кастомный метод Validate()
...
// функция для получения обновления пользователя из запроса
